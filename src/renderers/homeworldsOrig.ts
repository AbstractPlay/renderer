 ...
 *
 */
export class HomeworldsOrigRenderer extends RendererBase {

    public static readonly rendererName: string = "homeworlds-orig";
    ...
    public render(json: APRenderRep, draw: Svg, options: IRendererOptionsIn): void {
        ...
        if ( (! Array.isArray(this.json.board)) || ( (this.json.board.length > 0) && (! this.json.board[0].hasOwnProperty("stars")) ) ) {
            throw new Error(`This 'board' schema cannot be handled by the '${ HomeworldsOrigRenderer.rendererName }' renderer.`);
        }
