...
sheet.glyphs.set("piecepack-misc-tile-back", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 738);
    group.rect(738, 738).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-number-0", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 701);
    group.rect(701, 701).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-number-1", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 678);
    group.rect(678, 678).fill({opacity: 0});
    group.path("M175,456l-69,175l254,169h207V127H324v437L175,456z")
        .attr("data-playerfill", true)
        .rotate(180).flip("x")
        .translate(2.217, -124.5)
        .stroke({width: 5, color: "#000"})
        .fill("#000");
    return group;
});
...
sheet.glyphs.set("piecepack-number-2", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 689.02435);
    group.rect(689.02435, 689.02435).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-number-5", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 690.02344);
    group.rect(690.02344, 690.02344).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-number-6", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 701.01892);
    group.rect(701.01892, 701.01892).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-number-8", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 701.02032);
    group.rect(701.02032, 701.02032).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-number-void", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 675);
    group.rect(675, 675).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-suit-anchors", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 713.31494);
    group.rect(713.31494, 713.31494).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-suit-clubs", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 662);
    group.rect(662, 662).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-suit-crowns", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 720.04419);
    group.rect(720.04419, 720.04419).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-suit-fleurdelis", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 455.41803);
    group.rect(455.41803, 455.41803).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-suit-hearts", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 677.84711);
    group.rect(677.84711, 677.84711).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-suit-moons", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 650);
    group.rect(650, 650).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-suit-spades", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 695.08716);
    group.rect(695.08716, 695.08716).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-suit-stars", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 744.48004);
    group.rect(744.48004, 744.48004).fill({opacity: 0});
...
sheet.glyphs.set("piecepack-suit-suns", (canvas: SVGContainer) => {
    const group = canvas.group()
        ...
        .attr("data-cellsize", 768.02325);
    group.rect(768.02325, 768.02325).fill({opacity: 0});
