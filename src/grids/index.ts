...
export {type GridPoints, type IPoint, hexOfCir, hexOfHex, hexOfTri, hexSlanted, rectOfRects, snubsquare, pentagonal, bentTri, star, cobweb, wheel, cairo, conicalHex, genConicalHexPolys, pyramidHex, genPyramidHexPolys, type Poly, type IPolyCircle, type IPolyPath, type IPolyPolygon, SnubStart, PentagonOrientation};
